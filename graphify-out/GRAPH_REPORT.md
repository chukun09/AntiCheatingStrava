...
## Corpus Check
- 33 files · ~25,397 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 193 nodes · 453 edges · 14 communities
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b9feaeec`
...
Cohesion: 0.14
Nodes (29): enqueueActivityTask(), handleWebhookEvent(), BestPaceQueryOptions, processActivityQueueItem(), checkRateLimitHeaders(), fetchStravaActivityDetail(), getValidAccessToken(), sleep() (+21 more)

### Community 8 - "auth.controller.ts"
Cohesion: 0.15
Nodes (16): checkDistribution(), handleStravaCallback(), handleStravaLink(), handleSyncAll(), decrementPendingApp(), getAppCredentials(), getAvailableStravaApp(), getStravaAppPool() (+8 more)
